...
//!
//! Exposes nine tools (`list-sessions`, `list-panes`, `spawn-pane`,
//! `spawn-pane-with-target`, `send-text`, `read-pane`, `focus-pane`,
//! `resize-pane`, `kill-pane`), all addressing panes by zellij's stable
